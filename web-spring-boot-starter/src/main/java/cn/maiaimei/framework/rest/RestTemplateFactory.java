...
public class RestTemplateFactory {
    ...
    public static <T extends RestLoggingInterceptor> RestTemplate getRestTemplate(T restLoggingInterceptor, RestErrorHandler restErrorHandler) throws NoSuchAlgorithmException, KeyStoreException, KeyManagementException {
